                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="mb-4" data-flickity='{"draggable": false, "fade": true}' id="productSlider">
                                    ...
                                    <!-- Item -->
                                    <a href="#" data-bigpicture='{ "imgSrc": "{{ asset('client/assets/img/products/product-7.jpg') }}"}'>
                                        <img src="{{ asset('client/assets/img/products/product-7.jpg') }}" alt="..." class="card-img-top">
                                    </a>

                                    <!-- Item -->
                                    <a href="#" data-bigpicture='{ "imgSrc": "{{ asset('client/assets/img/products/product-122.jpg') }}"}'>
                                        <img src="{{ asset('client/assets/img/products/product-122.jpg') }}" alt="..." class="card-img-top">
                                    </a>

                                    <!-- Item -->
                                    <a href="#" data-bigpicture='{ "imgSrc": "{{ asset('client/assets/img/products/product-146.jpg') }}"}'>
                                        <img src="{{ asset('client/assets/img/products/product-146.jpg') }}" alt="..." class="card-img-top">
                                    </a>
                            ...
                            <div class="flickity-nav mx-n2 mb-10 mb-md-0"
                                ...
                                <div class="col-12 px-2" style="max-width: 113px;">
                                    ...
                                    <div class="ratio ratio-1x1 bg-cover"
                                        style="background-image: url({{ asset('client/assets/img/products/product-7.jpg') }});"></div>
                                ...
                                <div class="col-12 px-2" style="max-width: 113px;">
                                    ...
                                    <!-- Image -->
                                    <div class="ratio ratio-1x1 bg-cover"
                                        style="background-image: url({{ asset('client/assets/img/products/product-122.jpg') }});"></div>
                                ...
                                <div class="col-12 px-2" style="max-width: 113px;">
                                    ...
                                    <!-- Image -->
                                    <div class="ratio ratio-1x1 bg-cover"
                                        style="background-image: url({{ asset('client/assets/img/products/product-146.jpg') }});"></div>
                        ...
                        <div class="col-12 col-md-6 ps-lg-10">
                            ...
                            <form>
                                    ...
                                    <div class="mb-8 ms-n1">
                                        <div class="form-check form-check-inline form-check-img">
                                            <input type="radio" class="form-check-input" id="imgRadioOne" name="imgRadio"
                                                ...
                                                style="background-image: url({{ asset('client/assets/img/products/product-7.jpg') }});" checked>
                                        </div>
                                        <div class="form-check form-check-inline form-check-img">
                                            <input type="radio" class="form-check-input" id="imgRadioTwo" name="imgRadio"
                                                data-toggle="form-caption" data-target="#colorCaption" value="Black"
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Size chart -->
                                    <p class="mb-8">
                                        <img src="{{ asset('client/assets/img/icons/icon-ruler.svg') }}" alt="..." class="img-fluid"> <a
                                            class="text-reset text-decoration-underline ms-3" data-bs-toggle="modal"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <p class="text-gray-500">
                                                Won't herb first male seas, beast. Let upon, female upon third fifth every.
                                                Man subdue rule after years herb after
                                                form. And image may, morning. Behold in tree day sea that together cattle
                                ...
                                <div class="col-12 col-lg-10 col-xl-8">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <!-- Size -->
                                            <p class="mb-0">
                                                <img src="{{ asset('client/assets/img/icons/icon-ruler.svg') }}" alt="..."
                                                    class="img-fluid">
                            ...
                            <div class="review-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md">
                                        ...
                                        <!-- Text -->
                                        <p class="text-gray-500">
                                            Justo ut diam erat hendrerit. Morbi porttitor, per eu. Sodales curabitur diam
                            ...
                            <div class="review-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md">
                                        ...
                                        <!-- Text -->
                                        <p class="text-gray-500">
                                            Shall good midst can't. Have fill own his multiply the divided. Thing great. Of
                                            heaven whose signs.
                                        </p>
