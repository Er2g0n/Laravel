    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <label>Email</label>
                <input type="text" class="form-control" placeholder="Enter email" name="email" value="{{ old('email',$user->email) }}" {{-- disabled --}}> {{-- Sử dụng disable để người dùng ko sửa được tên email, --}}
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Enter password" name="password"> {{-- password ko cần giữ lại nên ko dùng phương thức old --}}
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Enter password" name="password_confirmation"> {{-- đổi name là password_confirmation thì mới chạy được confirm bên store --}}
                    </div>
